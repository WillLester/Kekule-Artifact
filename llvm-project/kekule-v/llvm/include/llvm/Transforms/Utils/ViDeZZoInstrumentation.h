...
struct ViDeZZoInstrumentationPass: public PassInfoMixin<ViDeZZoInstrumentationPass> {
  InstrumentationPointList instrumentation_point_list;

  bool callstack_initialized;
  
  ViDeZZoInstrumentationPass(InstrumentationPointList instrumentation_point_list = {})
      : instrumentation_point_list(instrumentation_point_list) {
  }
