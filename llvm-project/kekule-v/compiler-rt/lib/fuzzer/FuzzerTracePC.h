...
private:
	...
	std::unordered_map<size_t, unordered_set<size_t>> edges;
};
...
class TracePC {
 public:
  ...
  template <class Callback> size_t CollectFeatures(Callback CB, bool StatefuFeedback) const;
...
TracePC::CollectFeatures(Callback HandleFeature, bool StatefulFeedback) const {
