...
private:
  ...
  // Hash functions
  size_t HashNode(uint8_t Node);
  size_t HashEdge(uint8_t Node1, uint8_t Node2, uint8_t CoveredNum);
  size_t HashValue(uint8_t Value);
  size_t HashCombine(uint8_t Value1, uint8_t Value2);
